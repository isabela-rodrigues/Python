...
frequency = [0] * 100  # Covers numbers from 0 to 99
    
# Step 2: Count occurrences of each number in the input array
for num in arr:
    print(f"Número: {num}   A frequência desse número é:  {frequency[num]} \n\n")

    frequency[num] += 1

(f"A frequência final de cada número é: [{frequency}]")
